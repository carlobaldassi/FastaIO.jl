...
{
    "location": "index.html#FastaIO.jl-—-FASTA-file-reader-and-writed-module-1",
    "page": "Home",
    "title": "FastaIO.jl — FASTA file reader and writed module",
    "category": "section",
...
{
    "location": "index.html#Introductory-notes-1",
    "page": "Home",
...
{
    "location": "index.html#FastaIO.readentry",
    "page": "Home",
...
{
    "location": "index.html#Base.readstring-Tuple{FastaIO.FastaReader}",
    "page": "Home",
    "title": "Base.readstring",
    "category": "Method",
    "text": "readstring(fr::FastaReader)\n\nThis function extends Base.readstring: it parses a whole FASTA file at once, and returns an array of tuples, each one containing the description and the sequence (see also the readfasta function).\n\n\n\n"
},

{
    "location": "index.html#FastaIO.rewind-Tuple{FastaIO.FastaReader}",
    "page": "Home",
...
{
    "location": "index.html#Base.eof-Tuple{FastaIO.FastaReader}",
    "page": "Home",
    "title": "Base.eof",
    "category": "Method",
...
{
    "location": "index.html#Base.close-Tuple{FastaIO.FastaReader}",
    "page": "Home",
    "title": "Base.close",
    "category": "Method",
...
{
    "location": "index.html#Reading-files-1",
    "page": "Home",
    "title": "Reading files",
    "category": "section",
    "text": "readfastaFastaReader(::Union{AbstractString,IO})FastaReader(::Function, ::AbstractString)readentryreadstring(::FastaReader)rewind(::FastaReader)eof(::FastaReader)close(::FastaReader)"
},

{
    "location": "index.html#FastaIO.writefasta-Tuple{AbstractString,Any}",
    "page": "Home",
...
{
    "location": "index.html#FastaIO.writefasta-Tuple{IO,Any}",
    "page": "Home",
    "title": "FastaIO.writefasta",
    "category": "Method",
...
{
    "location": "index.html#FastaIO.FastaWriter",
    "page": "Home",
...
{
    "location": "index.html#FastaIO.writeentry",
    "page": "Home",
...
{
    "location": "index.html#Base.write-Tuple{FastaIO.FastaWriter,Any}",
    "page": "Home",
    "title": "Base.write",
    "category": "Method",
...
{
    "location": "index.html#Base.close-Tuple{FastaIO.FastaWriter}",
    "page": "Home",
    "title": "Base.close",
    "category": "Method",
...
{
    "location": "index.html#Writing-files-1",
    "page": "Home",
    "title": "Writing files",
    "category": "section",
